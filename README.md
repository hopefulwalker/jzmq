...
-------------
1. support gradle to build jzmq-core & jzmq-devices.
2. change some files to support local compile.
3. Adapt the zeromq4.1. both version are copy from master on April. 24th, 2017.
